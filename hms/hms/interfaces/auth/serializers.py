...
from hms.domain.user_management.models import UserOTP
...
class TokenSerializer(serializers.Serializer):
    ...
    def validate(self, attr):
        user_app_service = UserAppService()
        new_password = attr.get("new_password").get("new_password")
        if not user_app_service.reset_password(
            attr.get("otp_token"), attr.get("user_id"), new_password
        ):
